-- AlterTable: Replace Apartment id with slug (derived from title)
...
UPDATE "Apartment" SET "slug" = 'apartment-' || "id" WHERE "slug" = '' OR "slug" IS NULL;

-- Step 4: Make slug NOT NULL
ALTER TABLE "Apartment" ALTER COLUMN "slug" SET NOT NULL;

-- Step 5: Drop old primary key and set new one
ALTER TABLE "Apartment" DROP CONSTRAINT "Apartment_pkey";
ALTER TABLE "Apartment" ADD CONSTRAINT "Apartment_pkey" PRIMARY KEY ("slug");

-- Step 6: Remove id column
ALTER TABLE "Apartment" DROP COLUMN "id";
